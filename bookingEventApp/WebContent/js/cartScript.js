...
$scope.cart = cart;
  ...
  $state.go("signin");
	...
	$scope.cartItem ={};
	$scope.hoursCanBook= [	{ start: '08:00 AM', end:'10:00 AM', price: '$90.00',  avail: 'Y', selected:'' },
						      {	start: '10:00 AM',end:'12:00 AM', price: '$90.00', avail: 'Y', selected:''},
						      { start: '13:00 PM', end:'15:00 PM',price: '$90.00', avail: 'Y', selected:''},
						      { start: '15:00 PM',end:'17:00 PM', price: '$90.00', avail: 'Y', selected:''},
						      { start: '17:00 PM',end:'19:00 PM', price: '$90.00', avail: 'Y',  selected:''},
						      { start: '19:00 PM', end:'21:00 PM', price: '$90.00',avail: 'Y',selected:'' }
					      ];
	$scope.addNewEvent = $scope.addNewEvent; //from directive
